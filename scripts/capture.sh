#!/usr/bin/env bash
# capture.sh — screenshot harness for etabli-nuage (v0.1.0). Reachable screens only;
# data screens require a running Nextcloud instance + credentials.
set -euo pipefail
DBG=com.raban.etabli.probe.debug

...
Établi Nuage bundles four modules under a single Nextcloud account. Each module stays in its own tab; sign-in covers all of them.
...
| Channel | App |
|---------|-----|
| Android (APK) — **development build** | [GitHub Releases](https://github.com/etabli-dev/etabli-nuage/releases) |
